...
import com.sage.android.databinding.FragmentContactBinding;
...
public class ContactFragment extends Fragment {
    ...
    private void callApi(Map<String, Object> categories) {
        ...
        call = myApiEndpointInterface.contactUs(categories);
    ...
    private void setResponseData(String jsonObject1) {
        mBinding.wvContact.getSettings().setJavaScriptEnabled(true);
        mBinding.wvContact.loadDataWithBaseURL("", jsonObject1, "text/html", "UTF-8", "");
    }
}
