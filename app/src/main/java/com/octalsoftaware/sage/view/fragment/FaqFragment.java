...
import com.sage.android.databinding.FragmentFaqBinding;
...
public class FaqFragment extends Fragment {
    ...
    private void setResponseData(String jsonObject1) {
        mBinding.wvFaq.getSettings().setJavaScriptEnabled(true);
        mBinding.wvFaq.loadDataWithBaseURL("", jsonObject1, "text/html", "UTF-8", "");
    }
}
